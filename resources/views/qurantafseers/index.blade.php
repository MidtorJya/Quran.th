...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  <ul class="navbar-nav mr-auto">
    ...
    <li class="nav-item">
    <a class="nav-link" href="{{ route('qurantafseers.index') }}">จัดการกุรอานตัฟซีร</a>    </li>
...
<div class="text-center">
                          <h1 class="h4 text-gray-900 mb-4">จัดการตัฟซีร</h1>
                       
                        </div>
<!-- <a class="btn btn-link float-end" href="{{ route('tafseers.create') }}">เพิ่มตัฟซีร</a> -->
<div class="row mt-2">
    <div class ="col-md-12">
    <a href ="{{ route('qurantafseers.create')}}" class ="btn btn-dark my-3"> เพิ่มตัฟซีร </a>
            ...
            <td>
                ...
                <div class="dropdown"> {{-- Dropdown --}}
                    ...
                    <ul class="dropdown-menu" aria-labelledby="actionDropdown">
                        <li><a class="dropdown-item" href="{{ route('qurantafseers.show', $tafseer->id) }}">ดู</a></li> {{-- View --}}
                        <li><a class="dropdown-item" href="{{ route('qurantafseers.edit', $tafseer->id) }}">แก้ไข</a></li> {{-- Edit --}}
                        <li>
